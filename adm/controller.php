...
if (isset($_POST['category']) && $_POST['category'] == "menuMove") {
    $menu = $_POST['menu'];
    echo $menu;
}
...
if (isset($_POST['join']) && $_POST['join'] == "join" && $_POST['code']=CODE) {
    ...
    $db_obj->InsertData("member", $array);
}
...
if (isset($_POST['login']) && $_POST['login'] == "login") {
    ...
    $array = $db_obj->select_where_with_param("member","mb_id = '".$mb_id."'");
    if (password_verify($mb_password, $array[0]['mb_password'])) { // 비밀번호가 일치하는지 비교합니다. 
        echo "right";
        ...
        alert('로그인 성공',"mgmt_save_form.php");
    } else { // 비밀번호 불 일치
        alert('아아디, 패스워드가 틀립니다.',"index.php");
    }
}
